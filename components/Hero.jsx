...
import { League_Spartan, Montserrat, Crimson_Pro } from 'next/font/google'
...
const crimsonPro = Crimson_Pro({ subsets: ['latin'], weight: ['600', '700'], style: ['italic'] })
        ...
        <>
            <section className="relative overflow-hidden border-t border-[#123f19] bg-[#f4efe8] text-[#484848]">
                <div className="relative mx-auto grid min-h-[520px] max-w-6xl items-center justify-items-center gap-8 px-6 py-10 sm:px-8 lg:grid-cols-[1fr_1fr] lg:justify-items-stretch lg:gap-12 lg:py-14">
                    <div className="mx-auto max-w-lg text-center lg:mx-0 lg:text-left">
                        <h1 className={`${leagueSpartan.className} text-5xl font-bold leading-[0.95] text-[#a8232f] sm:text-6xl lg:text-7xl`}>
                            Kain
                        ...
                        <p className={`${crimsonPro.className} mt-8 text-2xl italic text-[#4e8d2f] sm:text-3xl`}>
                            #Ayopakaikain
                        </p>
                    </div>
                    ...
                    <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
                        <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-[#432312]">
                            ...
                            />
                            <div className="absolute inset-x-0 bottom-0 bg-[#123f19] px-5 py-3">
                                <p className="text-xs font-semibold uppercase tracking-wider text-[#f4efe8] sm:text-sm">
                                    Handcrafted from NTT, Indonesia
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-[#fbf8f3] text-[#484848]">
                <div className="relative mx-auto max-w-6xl px-6 py-16 sm:px-8 lg:py-20">
                    <div className="max-w-6xl">
                        <h2 className={`${leagueSpartan.className} max-w-3xl text-3xl font-bold leading-tight text-[#173d1f] sm:text-4xl lg:text-5xl`}>
                            Clean water through
                    ...
                    <div className="mt-14 overflow-hidden rounded-2xl border border-[#e2dbcf] bg-[#f1ece4] shadow-[0_16px_45px_rgba(47,74,39,0.12)]">
                        <div className="grid lg:grid-cols-[1.00fr_1.00fr]">
                            ...
                            <div className="flex flex-col justify-center p-8 sm:p-10 lg:p-12">
                                <p className={`${crimsonPro.className} text-2xl italic text-[#4e8d2f] sm:text-3xl`}>Solar Chapter APAC</p>
                                <p className="mt-6 text-xs font-semibold uppercase tracking-widest text-[#4c4c4c] sm:text-sm">Six Regions, One Mission</p>
                                <p className={`${montserrat.className} mt-7 text-sm font-semibold leading-loose text-[#4c4c4c] sm:text-base`}>
                                ...
                                <div className="mt-9 grid gap-4 text-sm font-semibold leading-loose text-[#4c4c4c] sm:text-base">
                                    <p className="flex items-center gap-3">
                                        <Droplet size={17} strokeWidth={2.25} className="shrink-0 text-[#4e8d2f]" />
                                        West Lakekun, NTT — current clean water focus
                                    </p>
                                    <p className="flex items-center gap-3">
                                        <Users size={17} strokeWidth={2.25} className="shrink-0 text-[#4e8d2f]" />
                                        Indonesia, Singapore, China, Hong Kong, Taiwan &amp; Korea
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="bg-[#f4efe8] text-[#484848]">
                <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:py-20">
                    <div>
                        <h2 className={`${leagueSpartan.className} max-w-3xl text-3xl font-bold leading-tight text-[#a8232f] sm:text-4xl lg:text-5xl`}>
                            Every thread carries
                            <span className="block">a story — and a purpose</span>
                        </h2>

                        <div className="mt-10 grid gap-8">
                            <div className="border-t border-[#ded5c2] pt-7">
                                <div className="flex items-center gap-3">
                                    <span className="h-2 w-2 shrink-0 rounded-full bg-[#a8232f]" aria-hidden="true" />
                                    <h3 className={`${crimsonPro.className} text-2xl italic text-[#123f19]`}>
                                        The Mamas of NTT
                                    </h3>
                                </div>
                    ...
                    <div className="self-end rounded-3xl bg-[#123f19] p-8 text-[#f4efe8] sm:p-10 lg:p-12">
                        <p className={`${crimsonPro.className} text-2xl italic leading-tight sm:text-3xl`}>
                        ...
                        <div className="mt-8 divide-y divide-[#315f35]">
                            {[
                                ...
                                <div className="grid grid-cols-[3.25rem_1fr] gap-4 py-6 first:pt-0 last:pb-0" key={step}>
                                    <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#3f7521] text-base font-bold text-[#f4efe8]">
                                        {index + 1}
                                    </span>
